...
- **Design docs** (`docs/`, written in Chinese): `MVP.md`, `write-pipeline.md`, `modules.md`, `wal-design.md`, `filter-design.md`, `index-design.md`, `grpc-adapter-design.md`, `fts-design.md`, `roadmap.md`, `search-iterator-design.md`
